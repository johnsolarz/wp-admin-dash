...
Installing "WP Admin Dash" can be done either by searching for "WP Admin Dash" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
